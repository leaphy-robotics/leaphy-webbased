...
void loop() {
    ...
    private aceElementSubject$: BehaviorSubject<ElementRef<HTMLElement>> =
        new BehaviorSubject<ElementRef<HTMLElement>>(null);
    public aceElement$: Observable<ElementRef<HTMLElement>> =
        this.aceElementSubject$.asObservable();

    private aceEditorSubject$: BehaviorSubject<Ace.Editor> =
        new BehaviorSubject<Ace.Editor>(null);
    public aceEditor$: Observable<Ace.Editor> =
        this.aceEditorSubject$.asObservable();
    ...
    private libraryCacheSubject$: BehaviorSubject<Library[]> =
        new BehaviorSubject<Library[]>([]);
    private InstalledLibraries$: BehaviorSubject<InstalledLibrary[]> =
        new BehaviorSubject<InstalledLibrary[]>([]);
