...
export class UploadState {
    ...
    private errorSubject$: BehaviorSubject<false | string> =
        new BehaviorSubject(false);
    public error$ = this.errorSubject$.asObservable();

    private failedSubject$: BehaviorSubject<boolean> = new BehaviorSubject(
        false,
    );
    public failed$ = this.failedSubject$.asObservable();

    private USBConnectingSubject$: BehaviorSubject<
        false | ((port: USBDevice) => void)
    > = new BehaviorSubject(false);
    ...
    public async requestUSBDevice(): Promise<USBDevice> {
        ...
        return new Promise((resolve) =>
            this.USBConnectingSubject$.next(resolve),
        );
    }
