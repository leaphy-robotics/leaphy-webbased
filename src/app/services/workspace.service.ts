...
export class WorkspaceService {
    ...
    public async restoreWorkspaceFromMessage(message: any) {
        ...
        if (
            ...
            this.codeEditorState
                .getAceEditor()
                .session.setValue(message.payload.data as string);
            this.codeEditorState.setOriginalCode(
            ...
            this.blocklyState.setProjectFileHandle(
    ...
    public async saveWorkspaceAs(robotExtension: string) {
        ...
        fileNamesDialogRef.afterClosed().subscribe((name: string) => {
            ...
            if (this.appState.getCurrentEditor() == CodeEditorType.Beginner) {
                ...
                this.appState.getCurrentEditor() == CodeEditorType.Python
            ) {
                if (onPythonRobot) {
    ...
    public async saveWorkspace() {
        if (this.blocklyState.getProjectFileHandle()) {
            ...
            if (this.appState.getCurrentEditor() == CodeEditorType.Beginner) {
                ...
                await writable.write({
                    type: "write",
                    data: this.codeEditorState.getCode(),
                    position: 0,
                });
            }
    ...
    public async restoreWorkspaceTemp() {
        ...
        if (
            type == "beginner" &&
            this.appState.getCurrentEditor() == CodeEditorType.Beginner
        ) {
            ...
            type == "advanced" &&
            this.appState.getCurrentEditor() == CodeEditorType.CPP
        ) {
            try {
                this.codeEditorState
                    .getAceEditor()
                    .session.setValue(workspaceTemp);
